...
const AboutSection = () => {
  return (
    <section id="about" className="pt-16 bg-base-element  overflow-x-hidden mt-4 md:mt-10">
      <h2 className="text-center pb-6 px-3" >Who we Are</h2>
      <div className="px-2 md:px-12 flex items-center gap-y-8 gap-x-4 flex-col-reverse md:flex-row max-w-360 mx-auto">
        <div className="px-3 md:max-w-1/2 lg:max-w-2/3" >
