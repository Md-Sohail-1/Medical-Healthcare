...
const ServiceSection = () => {
  const services = [{
    ...
    body: "Regular check-ups, early health risk identification, and wellness planning.",
    symbol: "📋"
  }
]
  ...
  return (
    <section id="services" className="w-screen pt-16 md:mt-10 mt-4">
      <div className='max-w-360 mx-auto px-3 overflow-x-hidden'>
      ...
      <div className="px-2 md:px-12 grid md:grid-cols-2 lg:grid-cols-3 gap-4 mx-auto" >
