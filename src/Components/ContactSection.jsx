  ...
  return (
    <section id="contactUs" className="pt-16 md:pt-4 mt-4 md:mt-10" >
      <div className="flex flex-col pb-6 px-3 md:px-18 max-w-[1440px] mx-auto" >
        ...
        <button aria-label="Book an appointment button" className="mx-auto my-4 bg-base/80 active:outline-base active:outline-1 active:bg-base/80 focus:bg-base text-base-text px-6 py-3 rounded-md" >Book your Appointment</button>
      </div>
    </section>
  )
}
