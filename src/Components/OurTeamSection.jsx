...
const OurTeamSection = () => {
  ...
  return (
    <section id="ourTeam" className="w-screen pt-16 overflow-x-hidden md:mt-10 mt-4 " >
      <div className="px-2 md:px-12 max-w-360  mx-auto" >
        ...
        <div className="px-3 pb-2 gap-3 grid auto-cols-[minmax(300px,1fr)] auto-rows-auto grid-flow-col overflow-x-scroll" >
          {
            ourTeams.map((doctor)=>(
