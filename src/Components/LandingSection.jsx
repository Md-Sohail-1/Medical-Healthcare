export const LandingSection = () => {
  return (
    ...
    bg-cover bg-right">
      <section className="max-w-360 overflow-x-hidden mx-auto px-5 md:px-15 min-h-screen flex flex-col  justify-center" > 
        ...
        <div className='w-screen justify-center hidden lg:flex absolute z-40 bottom-8 left-1/2 gap-4 flex-wrap -translate-x-1/2'>
