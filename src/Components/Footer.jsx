...
const Footer = () => {
  const date = new Date()
  return (
    <footer className="pt-4 bg-base/80 text-base-text flex flex-col gap-4 h-auto w-screen " >
      <div className="px-5 md:px-15 mx-auto max-w-[1440px] flex items-center gap-2 flex-col pt-5">
        <Logo />
        <ul className="flex gap-4" >
          <li>
            <a aria-label="our instagram social link" href="#">
          ...
          <li>
            <a aria-label="our twitter social link" href="#">
          ...
          <li>
            <a aria-label="our linkedin social link" href="#">
      ...
      <section className='px-5 md:px-15 flex items-center justify-between bg-black/70 text-base-text py-2 '>
