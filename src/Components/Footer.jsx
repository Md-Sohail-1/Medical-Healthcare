...
const Footer = () => {
  return (
    <footer className="pt-4 bg-base/80 text-base-text/90 flex flex-col gap-4 h-auto w-screen " >
      <div className="px-5 md:px-15 mx-auto max-w-[1440px] flex items-center gap-2 flex-col pt-5">
        <Logo />
      ...
      <div className="px-5 md:px-15 mx-auto min-w-full max-w-[1440px] flex md:gap-3 flex-col flex-col-1 md:flex-row " >
        ...
        <div className="w-full md:w-2/3" >
          <ul className="flex flex-col gap-1 *:py-1 *:text-base-text *:flex *:gap-2 *:items-center" >
            ...
            <li>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail-icon lucide-mail"><path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"/><rect x="2" y="4" width="20" height="16" rx="2"/></svg>
              medicalhealthcare@gmail.com 
            </li>
          </ul>
        </div>
      </div>
      <div className="px-5 md:px-15 mx-auto max-w-[1440px]" >
        <p className="text-center font-[poppins] text-sm font-thin" >© 2026 Medical Healthcare. All rights reserved.</p>
      </div>
      <section className='px-5 md:px-15 flex items-center justify-between bg-black/70 text-white py-2 '>
        <div className='flex items-center gap-1 *:text-[14px] md:*:text-lg'>
          <p>Made with</p> 
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#dd0000" stroke="currentColor" stroke-width=".125" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-heart-icon lucide-heart"><path d="M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5"/></svg>
          <p>By</p>
        ...
        <div className='flex gap-2 md:gap-4 text-xl md:text-2xl '>
          <a aria-label="view developer github profile"  href='https://github.com/Md-Sohail-1' target="_blank" className='group text-white'>
            <svg className='group-hover:text-slate-300 transition ease-in-out' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-github-icon lucide-github"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
          </a>
          <a aria-label="view developer linkedin profile"  href="https://linkedin.com" target="_blank" className='group text-white'>
            <svg className='group-hover:text-slate-300' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-linkedin-icon lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
          </a>
        </div>
      </section>
    </footer>
