...
const Footer = () => {
  const date = new Date()
  return (
    <footer className="pt-4 bg-primary text-base-text flex flex-col overflow-x-hidden gap-4 h-auto max-w-screen " >
      <div className="px-5 md:px-15 mx-auto max-w-360 overflow-x-hidden flex items-center gap-2 flex-col pt-5">
        <Logo />
        <ul className="flex gap-4" >
          <li>
            <a aria-label="our instagram social link" href="#" className='m-1 group bg-red-200'>
          ...
          <li>
            <a aria-label="our twitter social link" href="#" className='m-1 group'>
          ...
          <li>
            <a aria-label="our linkedin social link" href="#" className='m-1 group'>
